...
const SomeLocal = () => {
  return (
      <>
        <div className='container flex-col w-[85%] mx-auto flex mt-6 rounded-xl  justify-start items-start border-y border-gray-400 py-5' id='somewhat-local'>
        <h1 className=' font-bold w-[85%] mx-auto text-xl lg:text-3xl text-center lg:text-start'>Somewhat Local</h1>
